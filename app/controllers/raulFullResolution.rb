raulTickets = Ticket.recents.where(:a_id => 360303091423) 
    ...
    $raulfrch = fullResoDuringCalendarHours
    $raulfrbh = fullResoDuringBusinessHours
  ...
  $raulFullResoBusinessHours = median($raulfrbh)
  $raulFullResoCalendarHours = median($raulfrch)
